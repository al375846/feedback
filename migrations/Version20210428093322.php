 ...
 */
final class Version20210428093322 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE SEQUENCE no_active_user_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE apprentice (id INT NOT NULL, userdata_id INT DEFAULT NULL, username VARCHAR(180) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE expert (id INT NOT NULL, userdata_id INT DEFAULT NULL, username VARCHAR(180) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_4F1B9342AB945D82 ON expert (userdata_id)');
        $this->addSql('CREATE TABLE expert_categories (id INT NOT NULL, expert_id INT DEFAULT NULL, category_id INT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE no_active_user (id INT NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, participations TEXT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_F9E59C0DF85E0677 ON no_active_user (username)');
        $this->addSql('COMMENT ON COLUMN no_active_user.participations IS \'(DC2Type:array)\'');
        $this->addSql('CREATE TABLE publication (id INT NOT NULL, category_id INT NOT NULL, apprentice_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description TEXT NOT NULL, tags TEXT DEFAULT NULL, video TEXT DEFAULT NULL, document TEXT DEFAULT NULL, images TEXT DEFAULT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE valoration (id INT NOT NULL, feedback_id INT NOT NULL, expert_id INT NOT NULL, apprentice_id INT NOT NULL, grade INT NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP SEQUENCE no_active_user_id_seq CASCADE');
        ...
        $this->addSql('DROP TABLE no_active_user');
